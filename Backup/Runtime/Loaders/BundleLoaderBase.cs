...
namespace vFrame.Bundler.Loaders
{
    public abstract class BundleLoaderBase : Reference, IDisposable
    {
        ...
        public void Unload() {
            UnityEngine.Logger.LogInfo("Unload loader: {0}", this);
        ...
        public void ForceUnload() {
            UnityEngine.Logger.LogVerbose("ForceUnload - {0}", this);
        ...
        public override void Retain() {
            ...
            UnityEngine.Logger.LogVerbose("Retain loader: {0}, ref: {1}", _path, _references);
        }
        ...
        public override void Release() {
            ...
            UnityEngine.Logger.LogVerbose("Release loader: {0}, ref: {1}", _path, _references);
        }
